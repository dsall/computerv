...
print('\nset X340 ...')
swift.set_position(330, 190, 150, speed = 1500)
print('set X320 ...')
swift.set_position(320, 190, 150, speed = 1500)
print('set X300 ...')
swift.set_position(300, 190, 150, speed = 1500)
print('set X200 ...')
swift.set_position(200, 190, 150, speed = 1500)
print('set X190 ...')
swift.set_position(190, 190, 150, speed = 1500)

# wait all async cmd return before send sync cmd
swift.flush_cmd()

print('set Z100 ...')
swift.set_position(190, 200, 100, speed = 1500, wait = True)
print('set Z150 ...')
swift.set_position(190, 200, 150, speed = 1500, wait = True)
